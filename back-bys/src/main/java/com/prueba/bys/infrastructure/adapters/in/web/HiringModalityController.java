...
public class HiringModalityController {
    ...
    @GetMapping
    public ResponseEntity<PageResult<HiringModalityResponseDTO>> findAllEnabled(
    ...
    @GetMapping("/admin")
    public ResponseEntity<PageResult<HiringModalityResponseDTO>> findAll(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size,
            @RequestParam(defaultValue = "id") String sort){
    ...
    @GetMapping("/{id}")
    public ResponseEntity<HiringModalityResponseDTO> findOne(@PathVariable Long id) {
        HiringModality response = getHiringModalityUseCase.getById(id);
